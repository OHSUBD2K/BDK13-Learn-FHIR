...
1. Express clinical data using the Fast Health Interoperability Resources (FHIR) standard.
2. Implement applications in the Substitutable Medical Apps, Reusable Technology (SMART) framework.
...
This is a holding place for the git repo https://github.com/learnfhir/learnFHIR as it is currently being developed.
